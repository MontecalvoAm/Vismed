        ...
        return (
            <div
                ...
                style={{
                    ...
                    position: 'relative', // Ensures absolute children (like the watermark) bind to this container
                }}
            >
                ...
                <div style={{
                    ...
                    width: '400px',
                    height: '400px',
                    backgroundImage: 'url(/VisayasMedical.png)',
                ...
                <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
                    ...
                    <div style={{ flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
                        ...
                        <div style={{ marginBottom: '5mm' }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4px 24px' }}>
                                ...
                                {record.GuarantorName && (
                                    <div style={{ gridColumn: 'span 2', display: 'flex', paddingBottom: '4px', borderBottom: '1px solid #f1f5f9' }}>
                                        <span style={{ color: '#64748b', width: '22%', flexShrink: 0, fontSize: '10.5px' }}>Guarantor:</span>
                                        <strong style={{ color: '#0f172a', wordBreak: 'break-word', fontSize: '10.5px' }}>{record.GuarantorName}</strong>
                                    </div>
                                )}
                                {record.SessionType && (
                                    <div style={{ gridColumn: 'span 2', display: 'flex', paddingBottom: '4px', borderBottom: '1px solid #f1f5f9' }}>
                                        <span style={{ color: '#64748b', width: '22%', flexShrink: 0, fontSize: '10.5px' }}>Session Type:</span>
                                        <strong style={{ color: '#0f172a', wordBreak: 'break-word', fontSize: '10.5px' }}>
                        ...
                        {/* ── SERVICES TABLE ── */}
                        <div style={{ display: 'flex', flexDirection: 'column', marginBottom: '5mm' }}>
